...
select 
case when t1.name is not null then t1.name 
else t2.name end as name

, case when t1.income != t2.income then t2.income
when t1.income is null then t2.income
else t1.income end as income

, case when t1.income != t2.income then 'update'
when t1.income is null then 'addition'
else 'no chnage' end as status
